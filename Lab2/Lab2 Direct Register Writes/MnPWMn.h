...
enum {
    ...
    PWM_ENUPD    =   (0x028 >> 2), // Enable update register
    ...
    PWM1_DBCTL   =   (0x0A8 >> 2), // Generator B
    PWM1_DBRISE  =   (0x0AC >> 2), // Generator B
    PWM1_DBFALL  =   (0x0B0 >> 2), // Generator B
    ...
    PWM0_DBCTL   =   (0x068 >> 2), // Generator B
    PWM0_DBRISE  =   (0x06C >> 2), // Generator B
    PWM0_DBFALL  =   (0x070 >> 2), // Generator B
