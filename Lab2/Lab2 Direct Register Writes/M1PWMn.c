...
void initM1PWMn(void) {
    ...
    //â–  Write the PWM0CMPB register with a value of 0x0000.0063.
    //Generator 0
    ...
    //â–  Write the PWM0CTL register with a value of 0x0000.0001.
    //Generator 0
    M1PWM[PWM0_CTL] |= (1 << 0);
    //Generator 1
    M1PWM[PWM1_CTL] |= (1 << 0);
    ...
    //â–  Write the PWMENABLE register with a value of 0x0000.0002.
    M1PWM[PWM_ENABLE] |= (0x6 << 0);
